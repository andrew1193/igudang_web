...
namespace Nop.Plugin.Widgets.NivoSlider.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int RightPicture1Id { get; set; }
        public bool RightPicture1Id_OverrideForStore { get; set; }

        [AllowHtml]
        public string RightLink1 { get; set; }
        public bool RightLink1_OverrideForStore { get; set; }


        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Text")]
        [AllowHtml]
        public string RightText1 { get; set; }
        public bool RightText1_OverrideForStore { get; set; }
        ...
        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Picture")]
        [UIHint("Picture")]
        public int RightPicture2Id { get; set; }
        public bool RightPicture2Id_OverrideForStore { get; set; }

        [AllowHtml]
        public string RightLink2 { get; set; }
        public bool RightLink2_OverrideForStore { get; set; }


        [NopResourceDisplayName("Plugins.Widgets.NivoSlider.Text")]
        [AllowHtml]
        public string RightText2 { get; set; }
        public bool RightText2_OverrideForStore { get; set; }
