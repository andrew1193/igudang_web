...
namespace Nop.Plugin.Api.Infrastructure
{
    public class DependencyRegister : IDependencyRegistrar
    {
        ...
        private void RegisterControllers(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<CountriesController>().InstancePerLifetimeScope();
            builder.RegisterType<StatesController>().InstancePerLifetimeScope();
            builder.RegisterType<EventsController>().InstancePerLifetimeScope();
            //builder.RegisterType<StoreController>().InstancePerLifetimeScope();
        }
        ...
        private void RegisterPluginServices(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<StateApiService>().As<IStateApiService>().InstancePerLifetimeScope();
            builder.RegisterType<StoreApiService>().As<IStoreApiService>().InstancePerLifetimeScope();
        }
