...
namespace Nop.Plugin.Api
{
    public class Startup
    {
        ...
        private void ConfigureWebApi(IAppBuilder app)
        {
            ...
            config.Routes.MapHttpRoute(
             name: "ResetPassword",
             routeTemplate: "api/reset_password",
             defaults: new { controller = "Customers", action = "ResetPassword" },
             constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });
            ...
            config.Routes.MapHttpRoute(
             name: "customerLogin",
             routeTemplate: "api/customerLogin",
             defaults: new { controller = "Customers", action = "GetCustomerLogin" },
             constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });

            config.Routes.MapHttpRoute(
             name: "updateCartList",
             routeTemplate: "api/update_shopping_cart",
             defaults: new { controller = "ShoppingCartItems", action = "UpdateCartList" },
             constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });

            config.Routes.MapHttpRoute(
              name: "removeCartList",
              routeTemplate: "api/remove_shopping_cart",
              defaults: new { controller = "ShoppingCartItems", action = "RemoveCartList" },
              constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "GetAllShippingMethod",
                routeTemplate: "api/shippingMethod",
                defaults: new { controller = "Orders", action = "GetAllShippingMethod" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "GetWishlistItemsByCustomerId",
                routeTemplate: "api/GetWishlistItemsByCustomerId",
                defaults: new { controller = "ShoppingCartItems", action = "GetWishlistItemsByCustomerId" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
               name: "GetProductReviewsByProductId",
               routeTemplate: "api/GetProductReviewsByProductId",
               defaults: new { controller = "Products", action = "GetProductReviewsByProductId" },
               constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
               name: "GetProductRatingByProductId",
               routeTemplate: "api/GetProductRatingByProductId",
               defaults: new { controller = "Products", action = "GetProductRatingByProductId" },
               constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "countries",
                routeTemplate: "api/countries",
                defaults: new { controller = "Countries", action = "GetCountries" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
               name: "states",
               routeTemplate: "api/states",
               defaults: new { controller = "States", action = "GetStates" },
               constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "statesByCountryId",
                routeTemplate: "api/states/{countryId}",
                defaults: new { controller = "States", action = "GetStatesByCountryId" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "GetBannerImages",
                routeTemplate: "api/GetBannerImages",
                defaults: new { controller = "Store", action = "GetBannerImages" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
                name: "GetAnywaySliderImages",
                routeTemplate: "api/GetAnywaySliderImages/{sliderId}",
                defaults: new { controller = "Store", action = "GetAnywaySliderImages" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
               name: "GetCurrentEvent",
               routeTemplate: "api/GetCurrentEvent",
               defaults: new { controller = "Events", action = "GetCurrentEvent" },
               constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });

            config.Routes.MapHttpRoute(
             name: "ApplyCouponCodeDiscount",
             routeTemplate: "api/ApplyCouponCodeDiscount",
             defaults: new { controller = "ShoppingCartItems", action = "ApplyCouponCodeDiscount" },
             constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });

            config.Routes.MapHttpRoute(
             name: "ApplyDiscountCoupon",
             routeTemplate: "api/ApplyDiscountCoupon",
             defaults: new { controller = "ShoppingCartItems", action = "ApplyDiscountCoupon" },
             constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });

            config.Routes.MapHttpRoute(
            name: "RemoveDiscountCoupon",
            routeTemplate: "api/RemoveDiscountCoupon",
            defaults: new { controller = "ShoppingCartItems", action = "RemoveDiscountCoupon" },
            constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Post) });

            config.Routes.MapHttpRoute(
                name: "GetOrderTotal",
                routeTemplate: "api/GetOrderTotal/{customerId}",
                defaults: new { controller = "ShoppingCartItems", action = "GetOrderTotal" },
                constraints: new { httpMethod = new HttpMethodConstraint(HttpMethod.Get) });
