    ...
    public partial class ProductModelFactory : IProductModelFactory
    {
            ...
            bool forceRedirectionAfterAddingToCart = false)
        {
            ...
            foreach (var product in products)
            {
                ...
                var item = _productService.GetProductById(product.Id);
                var avalaible = (item.StockQuantity == 0) ? false : true;
                ...
                var model = new ProductOverviewModel
                {
                    ...
                    MarkAsBestSeller = item.IsBestSeller,
                    MarkAsSellingFast = item.MarkAsSellingFast,
            ...
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            if (product.VendorId > 0)
            {
                ...
                if (ev != null)
                {
                    model.ProductEvent = PrepareProductEventModel(ev, product);
                }
            }
        ...
        protected virtual ProductDetailsModel.ProductEventModel PrepareProductEventModel(Event ev, Product product)
        {
            var productEventModel = new ProductDetailsModel.ProductEventModel
            {
                Id = ev.Id,
                Name = ev.Name,
                StartDate = ev.StartedOnUtc,
                EndDate = ev.EndedOnUtc,
            };
