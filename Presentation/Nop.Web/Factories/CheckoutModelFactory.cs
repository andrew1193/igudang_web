    ...
    public partial class CheckoutModelFactory : ICheckoutModelFactory
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (billAddress != null)
            {
                ...
                _addressModelFactory.PrepareAddressModel(billAddressModel, address: billAddress, excludeProperties: false, addressSettings: _addressSettings);
                model.ExistingAddresses.Add(billAddressModel);
            }


            //var shipAddress = _workContext.CurrentCustomer.BillingAddress;
            //if (shipAddress != null)
            //{
            //    var shipAddressModel = new AddressModel();
            //    _addressModelFactory.PrepareAddressModel(shipAddressModel, address: shipAddress, excludeProperties: false, addressSettings: _addressSettings);
            //    model.ExistingAddresses.Add(shipAddressModel);
            //}
