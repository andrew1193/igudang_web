...
namespace Nop.Web.Factories
{
    public partial class CatalogModelFactory : ICatalogModelFactory
    {
        ...
        public virtual void PrepareSortingOptions(CatalogPagingFilteringModel pagingFilteringModel, CatalogPagingFilteringModel command)
        {
            ...
            pagingFilteringModel.CategoryFilterList = PrepareCategorySimpleModels();
            //if (cachedCategoriesModel.Count() > 0)
            //{
            //    foreach (var item in cachedCategoriesModel)
            //    {
            //        pagingFilteringModel.AvailableCategory.Add(new SelectListItem
            //        {
            //            Text = item.Name,
            //            Value = item.Id.ToString(),
            //            Selected = item.Id.ToString() == command.CategoryId
            //        });
            //    }
            //}
