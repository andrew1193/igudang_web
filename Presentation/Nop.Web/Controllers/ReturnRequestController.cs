...
namespace Nop.Web.Controllers
{
    public partial class ReturnRequestController : BasePublicController
    {
        ...
        public virtual ActionResult ReturnRequestSubmit(int orderId, SubmitReturnRequestModel model, FormCollection form)
        {
            ...
            {
                var returnRequest = _returnRequestService.GetReturnRequestByOrderItemId(orderItem.Id);
                 if (returnRequest != null){
                    if(returnRequest.ReturnRequestStatus != ReturnRequestStatus.Cancelled)
                    {
                        model.Result = _localizationService.GetResource("ReturnRequests.AlreadySubmitted");
                        break;
                    }
                }
