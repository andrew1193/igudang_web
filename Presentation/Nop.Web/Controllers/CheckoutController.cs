...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual ActionResult OpcBillingForm()
        {
            ...
            var billingAddressModel = _checkoutModelFactory.PrepareBillingAddressModel(cart, selectedCountryId:53, prePopulateNewAddressWithCustomerFields: true);
        ...
        public virtual ActionResult OpcSaveBilling(FormCollection form)
        {
            try
            {
                ...
                if (billingAddressId > 0)
                {
                    ...
                    var address = _addressService.GetAddressById(billingAddressId);
                    if (address == null)
        ...
        public virtual ActionResult OpcSaveShipping(FormCollection form)
        {
            try
            {
                ...
                if (shippingAddressId > 0)
                {
                    ...
                    var address = _addressService.GetAddressById(shippingAddressId);
                    if (address == null)
                        throw new Exception("Address can't be loaded");
