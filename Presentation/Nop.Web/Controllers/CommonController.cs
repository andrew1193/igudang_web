...
namespace Nop.Web.Controllers
{
    public partial class CommonController : BasePublicController
    {
        ...
        //igudang wishlist button
        [ChildActionOnly]
        public virtual ActionResult WishlistButton()
        {
            var model = _commonModelFactory.PrepareHeaderLinksModel();
            return PartialView(model);
        }

        //igudang account button
        [ChildActionOnly]
        public virtual ActionResult AccountButton()
        {
            var model = _commonModelFactory.PrepareHeaderLinksModel();
            return PartialView(model);
        }
        ...
        public virtual ActionResult ContactUsSend(ContactUsModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ViewBag.Message = string.Format("Submitted");
                return View(model);
            }
