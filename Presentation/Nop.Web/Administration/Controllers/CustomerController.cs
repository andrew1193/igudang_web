...
namespace Nop.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected virtual string ValidateCustomerRoles(IList<CustomerRole> customerRoles)
        {
            ...
            bool isInVendorRole = customerRoles.FirstOrDefault(cr => cr.SystemName == SystemCustomerRoleNames.Vendors) != null;
        ...
        //[NonAction]
        //protected virtual void PrepareEventsModel(CustomerModel model)
        //{
        //    if (model == null)
        //        throw new ArgumentNullException("model");
