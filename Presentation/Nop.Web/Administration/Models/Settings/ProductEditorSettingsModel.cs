...
namespace Nop.Admin.Models.Settings
{
    public partial class ProductEditorSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.MarkAsBestSeller")]
        public bool MarkAsBestSeller { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.ProductEditor.MarkAsSellingFast")]
