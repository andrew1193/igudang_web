...
namespace Nop.Admin.Models.Orders
{
    public partial class ShipmentModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Orders.Shipments.NinjaVanStatus")]
        public string NinjaVanStatusName  { get; set; }
        ...
        [NopResourceDisplayName("Admin.Orders.Shipments.NinjaVanDeliveryDate")]
        [UIHint("DateNullable")]
        public DateTime? NinjaVanDeliveryDate { get; set; }

        [NopResourceDisplayName("Admin.Orders.Shipments.NinjaVanPickupDate")]
        [UIHint("DateNullable")]
        public DateTime? NinjaVanPickupDate { get; set; }

        [NopResourceDisplayName("Admin.Orders.Shipments.ParcelSize")]
        public int? ParcelSize { get; set; }

        [NopResourceDisplayName("Admin.Orders.Shipments.ParcelVolume")]
        public int? ParcelVolume { get; set; }

        [NopResourceDisplayName("Admin.Orders.Shipments.ParcelWeight")]
        ...
        [NopResourceDisplayName("Admin.Orders.Shipments.ShipperId")]
        ...
        public IList<SelectListItem> AvailableParcelSize { get; set; }

        public IList<SelectListItem> AvailableVendorsOrShippers { get; set; }
