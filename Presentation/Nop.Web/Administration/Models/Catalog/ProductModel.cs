...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.EventName")]
        public string EventName { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.EventStartDatetime")]
        public DateTime? EventStartDatetime { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.EventEndDatetime")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MarkAsBestSeller")]
        public bool MarkAsBestSeller { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MarkAsSellingFast")]
        public bool MarkAsSellingFast { get; set; }
