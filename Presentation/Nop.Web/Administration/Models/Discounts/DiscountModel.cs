...
namespace Nop.Admin.Models.Discounts
{
    ...
    public partial class DiscountModel : BaseNopEntityModel
    {
        ...
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.OrderAbove")]
        public decimal OrderAbove { get; set; }

        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.LimitationTimesPerCustomer")]
        public int LimitationTimesPerCustomer { get; set; }


        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.LimitationTimesPerTotal")]
        public int LimitationTimesPerTotal { get; set; }
