...
namespace Nop.Admin.Infrastructure.Cache
{
        ...
        IConsumer<EntityDeleted<Vendor>>
    {
        ...
        /// <summary>
        /// Key for events caching
        /// </summary>
        /// <remarks>
        /// {0} : show hidden records?
        /// </remarks>
        public const string EVENTS_LIST_KEY = "Nop.pres.admin.events.list-{0}";
        public const string EVENTS_LIST_PATTERN_KEY = "Nop.pres.admin.events.list";
