...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static CustomerPictureModel ToModel(this CustomerPicture entity)
        {
            return entity.MapTo<CustomerPicture, CustomerPictureModel>();
        }

        public static CustomerPicture ToEntity(this CustomerPictureModel model)
        {
            return model.MapTo<CustomerPictureModel, CustomerPicture>();
        }

        public static CustomerPicture ToEntity(this CustomerPictureModel model, CustomerPicture destination)
        {
            return model.MapTo(destination);
        }
