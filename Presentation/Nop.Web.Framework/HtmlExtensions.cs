...
namespace Nop.Web.Framework
{
    public static class HtmlExtensions
    {
            ...
            bool localizeLabels = true, object htmlAttributes = null, bool wrapTags = false)
        {
            ...
            var daysList = new TagBuilder("select class=\"selectpicker form-control\"");
            var monthsList = new TagBuilder("select class=\"selectpicker form-control\"");
            var yearsList = new TagBuilder("select class=\"MI-CLASS form-control\"");
            ...
            var divDays = new TagBuilder("div class=\"col-md-2 col-xs-4 date-padding\"");
            divDays.InnerHtml += daysList;
            var divMonths = new TagBuilder("div class=\"col-md-2 col-xs-4 date-padding\"");
            divMonths.InnerHtml += monthsList;
            var divYears = new TagBuilder("div class=\"col-md-2 col-xs-4 date-padding\"");
            divYears.InnerHtml += yearsList;
            ...
            {
                return MvcHtmlString.Create(string.Concat(divDays, divMonths, divYears));
            }

        }

        public static MvcHtmlString DatePickerDropDowns_register(this HtmlHelper html,
            string dayName, string monthName, string yearName,
            int? beginYear = null, int? endYear = null,
            int? selectedDay = null, int? selectedMonth = null, int? selectedYear = null,
            bool localizeLabels = true, object htmlAttributes = null, bool wrapTags = false)
        {
            ...
            monthsList.InnerHtml = months.ToString();
            yearsList.InnerHtml = years.ToString();
            var divDays = new TagBuilder("div class=\"col-lg-3\"");
            divDays.InnerHtml += daysList;
            var divMonths = new TagBuilder("div class=\"col-lg-3\"");
            divMonths.InnerHtml += monthsList;
            var divYears = new TagBuilder("div class=\"col-lg-3\"");
            divYears.InnerHtml += yearsList;
