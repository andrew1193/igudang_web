...
namespace Nop.Services.Tests.Customers
{
    ...
    public class CustomerRegistrationServiceTests : ServiceTest
    {
        ...
        private IRepository<CustomerPicture> _customerPictureRepo;
        ...
        public new void SetUp()
        {
            ...
            //_customerPictureRepo = MockRepository.GenerateMock<IRepository<CustomerPicture>>();
            ...
            _customerService = new CustomerService(new NopNullCache(), _customerRepo, _customerPictureRepo, _customerPasswordRepo, _customerRoleRepo,
            ...
            _customerRegistrationService = new CustomerRegistrationService(_customerService,
                ...
                _workflowMessageService, _eventPublisher, _rewardPointsSettings, _customerSettings, _vendorService, _eventService, _settingService);
        }
