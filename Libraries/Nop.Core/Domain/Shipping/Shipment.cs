...
namespace Nop.Core.Domain.Shipping
{
    ...
    public partial class Shipment : BaseEntity
    {
        ...
        /// <summary>
        /// Gets or sets the status of ninja van shipment
        /// </summary>
        public int NinjaVanStatusId { get; set; }

        public NinjaVanStatus NinjaVanStatus
        {
            get
            {
                return (NinjaVanStatus)this.NinjaVanStatusId;
            }
            set
            {
                this.NinjaVanStatusId = (int)value;
            }
        }
