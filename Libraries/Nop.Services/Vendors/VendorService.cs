...
namespace Nop.Services.Vendors
{
    ...
    public partial class VendorService : IVendorService
    {
        ...
        public IList<Vendor> GetVendorByEventId(int eventId)
        {
            var vendors = _vendorRepository.Table.ToList();
            vendors = vendors.Where(x => x.Deleted == false && x.EventId == eventId).ToList();

            return vendors;
        }

        public IList<Vendor> GetActiveVendors()
        {
            var vendors = _vendorRepository.Table.ToList();
            vendors = vendors.Where(x => x.Deleted == false && x.Active == true).ToList();
