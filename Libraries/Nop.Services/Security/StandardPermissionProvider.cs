...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageOnlineCustomers = new PermissionRecord { Name = "Admin area. Manage Online Customers", SystemName = "ManageCustomerRoles", Category = "Customers" };
        ...
        public static readonly PermissionRecord ManageEvents = new PermissionRecord { Name = "Admin area. Manage Events", SystemName = "ManageEvents", Category = "Events" };
        public static readonly PermissionRecord ManageMerchantEvents = new PermissionRecord { Name = "Admin area. Manage Merchant Events", SystemName = "ManageMerchantEvents", Category = "MerchantEvents" };
