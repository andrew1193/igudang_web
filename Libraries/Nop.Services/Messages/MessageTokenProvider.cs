...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddOrderTokens(IList<Token> tokens, Order order, int languageId, int vendorId = 0)
        {
            ...
            //TODO show order item table
            var sbOrderItem = new StringBuilder();
            sbOrderItem.Append("<table><tr><td>halo</td><td>byebye</td><td>oi</td></tr></table>");
            tokens.Add(new Token("Order.OrderItemTable", sbOrderItem.ToString(), true));
