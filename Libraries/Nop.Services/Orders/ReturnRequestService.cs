...
namespace Nop.Services.Orders
{
    ...
    public partial class ReturnRequestService : IReturnRequestService
    {
        ...
        public virtual ReturnRequest GetReturnRequestByOrderItemId(int OrderItemId)
        {
            if (OrderItemId == 0)
                return null;
            var query = _returnRequestRepository.Table.Where(x=>x.OrderItemId== OrderItemId).FirstOrDefault();
