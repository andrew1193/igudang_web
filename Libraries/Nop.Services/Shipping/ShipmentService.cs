...
namespace Nop.Services.Shipping
{
    ...
    public partial class ShipmentService : IShipmentService
    {
        ...
        public virtual List<string> GetPendingNinjaVanTrackingIds()
        {
            var query = (from a in _shipmentRepository.Table
                         where a.NinjaVanStatusId != (int)NinjaVanStatus.Completed
                         select a.TrackingNumber).ToList();

            return query;
        }

        public virtual Shipment GetShpmentByTrackingNumber(string trackingId)
        {
            var query = (from a in _shipmentRepository.Table
                         where a.TrackingNumber == trackingId
