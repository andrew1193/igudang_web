...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        CustomerPicture GetCustomerPictureById(int customerPictureId);

        void InsertCustomerPicture(CustomerPicture customerPicture);

        CustomerPicture GetCustomerPictureByPictureId(int customerPictureId);

        void UpdateCustomerPicture(CustomerPicture customerPicture);

        void DeleteCustomerPicture(CustomerPicture customerPicture);

        IPagedList<CustomerPicture> GetAllCustomerPictures(int pageIndex = 0, int pageSize = int.MaxValue);
